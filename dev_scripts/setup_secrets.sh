...
# RAG Engine - GCP Secret Manager Setup
...
create_or_update_secret "QDRANT_HOST" "${QDRANT_HOST}"
create_or_update_secret "QDRANT_API_KEY" "${QDRANT_API_KEY}"

# API Keys
create_or_update_secret "GEMINI_API_KEY" "${GEMINI_API_KEY}"
create_or_update_secret "OPENAI_API_KEY" "${OPENAI_API_KEY}"
create_or_update_secret "CRITIC_MODEL_API_KEY" "${CRITIC_MODEL_API_KEY}"
...
for secret in QDRANT_HOST QDRANT_API_KEY GEMINI_API_KEY OPENAI_API_KEY CRITIC_MODEL_API_KEY; do
...
echo ""
echo -e "${YELLOW}Next step:${NC} Run ./deploy.sh to deploy your application"
echo ""
